clear;
clc;close all;
A=imread('esther_01_no_flash.jpg');
F=imread('esther_02_flash.jpg');
Ac=A;
Fc=F;
A=im2double(A);
F=im2double(F);
...
idx = find([stats.Area] > 50 & [stats.Eccentricity] < 0.8 & [stats.MajorAxisLength] < 30 & [stats.MinorAxisLength] < 30); 
L=labelmatrix(cc);
