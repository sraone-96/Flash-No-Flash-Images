clear;
clc;close all;
A=imread('00_01_aligned_face_no_flash.jpg');
F=imread('00_02_aligned_face_flash.jpg');
Ac=A;
Fc=F;
%A=im2double(A);
%F=im2double(F);
...
idx = find([stats.Area] > 50 & [stats.Eccentricity] < 0.9 & [stats.MajorAxisLength] < 50 & [stats.MinorAxisLength] < 50); 
L=labelmatrix(cc);
